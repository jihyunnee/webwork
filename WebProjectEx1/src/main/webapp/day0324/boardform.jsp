...
<!-- 이미지 출력할곳 -->
 ...
 style="position: absolute;left:500px;top:50px;max-width: 300px;">

	<form action="boardaction.jsp" method="post" enctype="multipart/form-data">
		<table>
			<caption align="top"><b>게시글쓰기</b></caption>
			<tr>
			...
			<tr>
				...
				<td>
					<input type="text" name="subject" class="form-control" style="width : 130px;"
					required="required">
				</td>	
			</tr>
			<tr>
				<th style="background-color : #ddd" width="100">사 진(1 장)</th>
				<td>
			...
			<tr>
				...
				<button type="submit" class="btn btn-secondary btn-sm">게시글 저장</button>
