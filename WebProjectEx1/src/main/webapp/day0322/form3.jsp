...
<body>
<h4 class="alert alert-info">문제.post방식의 폼태그 전송</h4>
	<form action="action3.jsp" method="post">
		...
		<table class="table table-bordered" style="width : 400px">
			...
			class="form-control" placeholder="사원명입력">
			</td>
			</tr>
			<tr>
			<th>성별</th>
			...
			<td><div class="input-group">
				...
				name="hobby" value="낚시">낚시 &nbsp;</label>
				<label><input type="checkbox" class="form-check-input"
				name="hobby" value="게임">게임&nbsp;</label>
				<label><input type="checkbox" class="form-check-input"
				name="hobby" value="여행">여행 &nbsp;</label>
				<label><input type="checkbox" class="form-check-input"
				name="hobby" value="채팅">채팅 &nbsp;</label>
			</td>
			</tr>
			<tr>
			<th>이메일</th>
